<?php
$check_field = get_user_meta( get_current_user_id(), 'billing_'.$this->generate_name( $field[ 'woocommerce_extra_fields_setting_id_name' ] ), TRUE );
?>
        ...
        <?php if( is_array( $f ) ): ?>
            ...
            <input type="checkbox"
	               ...
	               if( isset($check_field) )
	                    checked($f[ 'woocommerce_extra_fields_setting_name_value' ], $check_field)
	               ?>
